...
const Trainers = () => {
  ...
  const handleAddTrainer = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setNewTrainer({ username: '', name: '', email: '', password: '', phone_number: '' });
        fetchTrainers();
      }
    } catch (error) {
  ...
  const handleUpdateTrainer = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`http://127.0.0.1:8000/api/admin/trainers/${editingTrainer.id}/`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
        },
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleAddTrainer}>
              ...
              <input
                ...
                onChange={(e) => setNewTrainer({...newTrainer, phone_number: e.target.value})}
                required
              />
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleUpdateTrainer}>
              ...
              <input
                ...
                onChange={(e) => setEditingTrainer({...editingTrainer, phone_number: e.target.value})}
                required
              />
              <div className="form-actions">
